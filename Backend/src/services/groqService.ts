...
import { GeneratedPaper, QuestionTypeConfig } from '../types';

let groq: Groq | null = null;
if (env.GROQ_API_KEY && !env.GROQ_API_KEY.includes('your-groq-key')) {
...
You MUST respond strictly in the following JSON format:
{
  ...
  "answerKey": [
    ...
    const parsed: GeneratedPaper = JSON.parse(rawJson);
